...
namespace alarm {
    int AlarmSchTickFct(int state) {
        ...
        case Al_Sch_Run:
            ...
            Serial.print(glue::schedule.turn_on_schedule[mtime::clock.t.time.week_day - 1].hours);
            Serial.print(" == ");
            Serial.println(mtime::clock.t.time.hours);
            Serial.print(glue::schedule.turn_on_schedule[mtime::clock.t.time.week_day - 1].minutes);
            Serial.print(" == ");
            Serial.println(mtime::clock.t.time.minutes);

            Serial.print(glue::schedule.turn_off_schedule[mtime::clock.t.time.week_day - 1].hours);
            Serial.print(" == ");
            Serial.println(mtime::clock.t.time.hours);
            Serial.print(glue::schedule.turn_off_schedule[mtime::clock.t.time.week_day - 1].minutes);
            Serial.print(" == ");
            Serial.println(mtime::clock.t.time.minutes);
